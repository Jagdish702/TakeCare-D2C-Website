...
import { PAYMENT_OPTIONS, ICON_SRC, ICON_SIZE, CashIcon, AlertCircleIcon } from './PaymentPage';

/*
  Mobile "Payment" — Figma node 12185:6450, the third/final checkout step.
  Reuses PAYMENT_OPTIONS/ICON_SRC/ICON_SIZE/CashIcon/AlertCircleIcon from the
  desktop PaymentPage (same payment-mode data + icons), DisclaimerCard and
...
function ContactShippingCardMobile({ shippingInfo, onChange }) {
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24, width: '100%' }}>
      ...
      <div style={{ width: '100%', background: '#fff', padding: 24, boxSizing: 'border-box', display: 'flex', flexDirection: 'column', gap: 24 }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, width: '100%' }}>
          <p style={{ margin: 0, width: '100%', fontFamily: FONT, fontWeight: 700, fontSize: 16, color: '#000', letterSpacing: '0.5178px', lineHeight: '24px' }}>Contact</p>
        ...
        <Divider />
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, width: '100%' }}>
          <p style={{ margin: 0, width: '100%', fontFamily: FONT, fontWeight: 700, fontSize: 16, color: '#000', letterSpacing: '0.5178px', lineHeight: '24px' }}>Shipping Address</p>
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: '#f9f9f9', zIndex: 1200, overflowY: 'auto' }}>
      <div style={{ width: '100%', padding: '48px 24px', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', gap: 48, alignItems: 'flex-start' }}>
        ...
        <ContactShippingCardMobile shippingInfo={shippingInfo} onChange={onBack} />
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, width: '100%' }}>
          ...
          <DisclaimerCard iconNode={<AlertCircleIcon />}>
            <p style={{ margin: 0, width: '100%', fontFamily: FONT, fontWeight: 500, fontSize: 12, color: '#000', letterSpacing: '0.3883px', lineHeight: '20px' }}>No duplicate charges</p>
